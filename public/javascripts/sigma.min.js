...
(function () {
    ...
    if (b.prototype.addCamera = function (a) {
            ...
            var c, d, e, f, g = a || {};
            if ("string" == typeof g ? g = {container: document.getElementById(g)} : g instanceof HTMLElement && (g = {container: g}), "id"in g)c = g.id; else {
            ...
            return f = new d(this.graph, e, this.settings, g), this.renderers[c] = f, Object.defineProperty(f, "id", {value: c}), f.bind && f.bind(["click", "rightClick", "clickStage", "doubleClickStage", "rightClickStage", "clickNode", "clickNodes", "doubleClickNode", "doubleClickNodes", "rightClickNode", "rightClickNodes", "overNode", "overNodes", "outNode", "outNodes", "downNode", "downNodes", "upNode", "upNodes"], this._handler), this.renderersPerCamera[e.id].push(f), f
            ...
            for (d in this.cameras)f = this.cameras[d], f.settings("autoRescale") && this.renderersPerCamera[f.id] && this.renderersPerCamera[f.id].length ? b.middlewares.rescale.call(this, e.length ? "ready:" : "", f.readPrefix, {
                ...
                prefix: f.readPrefix,
                bounds: {x: g.minX, y: g.minY, width: g.maxX - g.minX, height: g.maxY - g.minY}
            });
            for (e = Object.keys(this.renderers), a = 0, c = e.length; c > a; a++)if (this.renderers[e[a]].process)if (this.settings("skipErrors"))try {
            ...
            var a, b, c;
            for (c = Object.keys(this.renderers), a = 0, b = c.length; b > a; a++)if (this.settings("skipErrors"))try {
            ...
            var c, d, e, f = this;
            if (b)for (e = this.renderersPerCamera[a.id], c = 0, d = e.length; d > c; c++)if (this.settings("skipErrors"))try {
                e[c].render()
            } catch (g) {
                ...
                for (e = this.renderersPerCamera[a.id], c = 0, d = e.length; d > c; c++)if (this.settings("skipErrors"))try {
                    e[c].render()
                } catch (g) {
                    this.settings("verbose") && console.log('Warning: The renderer "' + e[c].id + '" crashed on ".render()"')
                } else e[c].render();
    ...
    function e() {
        ...
        if (c = g.job(), f = s() - f, g.done++, g.time += f, g.currentTime += f, g.weightTime = g.currentTime / (g.weight || 1), g.averageTime = g.time / g.done, d = g.count ? g.count <= g.done : !c, !d) {
            for (a = 0, b = x.length; b > a; a++)if (x[a].weightTime > g.weightTime) {
                x.splice(a, 0, g), e = !0;
                break
            }
            e || x.push(g)
    ...
    function i(a) {
        var b, c, e, f, g = !1;
        if (Array.isArray(a))for (b = 0, c = a.length; c > b; b++)i(a[b]); else {
            ...
            for (e = x, b = 0, c = e.length; c > b; b++)if (e[b].id === a) {
                e.splice(b, 1);
                break
            }
    ...
    function q(a) {
        var b, c, d;
        if (!a)return a;
        if (Array.isArray(a))for (b = [], c = 0, d = a.length; d > c; c++)b.push(q(a[c])); else if ("object" == typeof a) {
            b = {};
    ...
    var a = function () {
        var b, c, d = {}, e = Array.prototype.slice.call(arguments, 0), f = function (a, g) {
            ...
            if (1 === arguments.length && "string" == typeof a) {
                ...
                for (b = 0, c = e.length; c > b; b++)if (a in e[b] && void 0 !== e[b][a])return e[b][a];
                return void 0
            }
    ...
    j.addMethod = function (a, b) {
        ...
        var h;
        if ("constructor" === a)h = e; else if (d) {
        ...
        var b, c, d;
        for (delete this.nodesIndex[a], b = 0, d = this.nodesArray.length; d > b; b++)if (this.nodesArray[b].id === a) {
        ...
        var b, c, d;
        for (d = this.edgesIndex[a], delete this.edgesIndex[a], b = 0, c = this.edgesArray.length; c > b; b++)if (this.edgesArray[b].id === a) {
    ...
    sigma.utils.pkg("sigma.classes"), sigma.classes.camera = function (a, b, c, d) {
        ...
        for (c = 0, d = f.length; d > c; c++)if (e[f[c]] !== a) {
    ...
    function f(b, d, g) {
        if (g.level < g.maxLevel)for (var h = c(d, g.corners), i = 0, j = h.length; j > i; i++)g.nodes[h[i]] === a && (g.nodes[h[i]] = e(h[i], g)), f(b, d, g.nodes[h[i]]); else g.elements.push(b)
    }
    ...
    function h(b, c, d, e) {
        if (e = e || {}, c.level < c.maxLevel)for (var f = d(b, c.corners), g = 0, i = f.length; i > g; g++)c.nodes[f[g]] !== a && h(b, c.nodes[f[g]], d, e); else for (var j = 0, k = c.elements.length; k > j; j++)e[c.elements[j].id] === a && (e[c.elements[j].id] = c.elements[j]);
        return e
    }
    ...
    sigma.utils.pkg("sigma.captors"), sigma.captors.mouse = function (a, b, c) {
        ...
        function i(a) {
            ...
            return w("mouseEnabled") ? (c = 1 / w("doubleClickZoomingRatio"), t.dispatchEvent("doubleclick", {
                ...
                altKey: a.altKey,
                shiftKey: a.shiftKey
            }), w("doubleClickEnabled") && (b = v.cameraPosition(sigma.utils.getX(a) - a.target.width / 2, sigma.utils.getY(a) - a.target.height / 2, !0), d = {duration: w("doubleClickZoomDuration")}, sigma.utils.zoomTo(v, b.x, b.y, c, d)), a.preventDefault ? a.preventDefault() : a.returnValue = !1, a.stopPropagation(), !1) : void 0
        }
    ...
    sigma.utils.pkg("sigma.renderers"), sigma.renderers.canvas = function (a, b, c, d) {
        ...
        b = b || {};
        var c, d, e, f, g, h, i, j, k, l, m, n, o, p = {}, q = this.graph, r = this.graph.nodes, s = (this.options.prefix || "", this.settings(b, "drawEdges")), t = this.settings(b, "drawNodes"), u = this.settings(b, "drawLabels"), v = this.settings.embedObjects(b, {prefix: this.options.prefix});
        ...
        if (s) {
            ...
            }, this.jobs[h] = j, conrad.addJob(h, j.bind(this)); else for (m = sigma.canvas.edges, c = this.edgesOnScreen, d = 0, f = c.length; f > d; d++)g = c[d], (m[g.type] || m.def)(g, q.nodes(g.source), q.nodes(g.target), this.contexts.edges, v)
        }
        if (t)for (m = sigma.canvas.nodes, c = this.nodesOnScreen, d = 0, f = c.length; f > d; d++)c[d].hidden || (m[c[d].type] || m.def)(c[d], this.contexts.nodes, v);
        if (u)for (m = sigma.canvas.labels, c = this.nodesOnScreen, d = 0, f = c.length; f > d; d++)c[d].hidden || (m[c[d].type] || m.def)(c[d], this.contexts.labels, v);
    ...
    sigma.utils.pkg("sigma.renderers"), sigma.renderers.webgl = function (a, b, c, d) {
        ...
        for (a = f.edges(), b = 0, c = a.length; c > b; b++)d = a[b].type && sigma.webgl.edges[a[b].type] ? a[b].type : "def", this.edgeFloatArrays[d] || (this.edgeFloatArrays[d] = {edges: []}), this.edgeFloatArrays[d].edges.push(a[b]);
        for (a = f.nodes(), b = 0, c = a.length; c > b; b++)d = a[b].type && sigma.webgl.nodes[a[b].type] ? d : "def", this.nodeFloatArrays[d] || (this.nodeFloatArrays[d] = {nodes: []}), this.nodeFloatArrays[d].nodes.push(a[b]);
        ...
        d.style.position = "absolute", d.setAttribute("class", "sigma-" + b), this.domElements[b] = d, this.container.appendChild(d), "canvas" === a.toLowerCase() && (this.contexts[b] = d.getContext(c ? "experimental-webgl" : "2d", {preserveDrawingBuffer: !0}))
    ...
    sigma.utils.pkg("sigma.canvas.edges"), sigma.canvas.edges.curve = function (a, b, c, d, e) {
        var f, g, h, i, j = a.color, k = e("prefix") || "", l = e("edgeColor"), m = e("defaultNodeColor"), n = e("defaultEdgeColor"), o = b[k + "size"], p = b[k + "x"], q = b[k + "y"], r = c[k + "x"], s = c[k + "y"];
    ...
    sigma.utils.pkg("sigma.canvas.edges"), sigma.canvas.edges.arrow = function (a, b, c, d, e) {
        var f = a.color, g = e("prefix") || "", h = e("edgeColor"), i = e("defaultNodeColor"), j = e("defaultEdgeColor"), k = a[g + "size"] || 1, l = c[g + "size"], m = b[g + "x"], n = b[g + "y"], o = c[g + "x"], p = c[g + "y"], q = 2.5 * k, r = Math.sqrt(Math.pow(o - m, 2) + Math.pow(p - n, 2)), s = m + (o - m) * (r - q - l) / r, t = n + (p - n) * (r - q - l) / r, u = (o - m) * q / r, v = (p - n) * q / r;
        if (!f)switch (h) {
            case"source":
                f = b.color || i;
                break;
    ...
    a.curvedArrow = function (a, b, c, d, e) {
        var f, g, h, i, j = a.color, k = e("prefix") || "", l = e("edgeColor"), m = e("defaultNodeColor"), n = e("defaultEdgeColor"), o = c[k + "size"], p = b[k + "x"], q = b[k + "y"], r = c[k + "x"], s = c[k + "y"];
        b.id === c.id ? (f = p - 7 * o, g = q, h = p, i = q + 7 * o) : (f = (p + r) / 2 + (s - q) / 4, g = (q + s) / 2 + (p - r) / 4);
        var t = Math.sqrt(Math.pow(r - f, 2) + Math.pow(s - g, 2)), u = 2.5 * (a[k + "size"] || 1), v = f + (r - f) * (t - u - o) / t, w = g + (s - g) * (t - u - o) / t, x = (r - f) * u / t, y = (s - g) * u / t;
        if (!j)switch (l) {
            case"source":
                j = b.color || m;
                break;
    ...
    sigma.utils.pkg("sigma.middlewares"), sigma.utils.pkg("sigma.utils"), sigma.middlewares.rescale = function (a, b, c) {
        var d, e, f, g, h, i, j, k, l = this.graph.nodes(), m = this.graph.edges(), n = this.settings.embedObjects(c || {}), o = n("bounds") || sigma.utils.getBoundaries(this.graph, a, !0), p = o.minX, q = o.minY, r = o.maxX, s = o.maxY, t = o.sizeMax, u = o.weightMax, v = n("width") || 1, w = n("height") || 1, x = n("autoRescale");
        x instanceof Array || (x = ["nodePosition", "nodeSize", "edgeSize"]);
        var y = ~x.indexOf("nodePosition"), z = ~x.indexOf("nodeSize"), A = ~x.indexOf("edgeSize");
        ...
        if (c)for (d = 0, e = f.length; e > d; d++)h = Math.max(f[d][b + "size"], h);
    ...
    sigma.utils.pkg("sigma.misc"), sigma.misc.bindEvents = function (a) {
        function b(b) {
            ...
            if (r.length)for (c = 0, e = r.length; e > c; c++)if (i = r[c], j = i[a + "x"], k = i[a + "y"], l = i[a + "size"], !i.hidden && o > j - l && j + l > o && p > k - l && k + l > p && Math.sqrt(Math.pow(o - j, 2) + Math.pow(p - k, 2)) < l) {
                for (m = !1, d = 0; d < n.length; d++)if (i.size > n[d].size) {
                    n.splice(d, 0, i), m = !0;
                    break
                }
                m || n.push(i)
        ...
        function c(a) {
            function c(a) {
                h.settings("eventsEnabled") && (h.dispatchEvent("click", a.data), i = b(a), i.length ? (h.dispatchEvent("clickNode", {
                    ...
                    node: i,
                    captor: a.data
                })) : h.dispatchEvent("clickStage", {captor: a.data}))
            }
            ...
            function d(a) {
                h.settings("eventsEnabled") && (h.dispatchEvent("doubleClick", a.data), i = b(a), i.length ? (h.dispatchEvent("doubleClickNode", {
                    ...
                    node: i,
                    captor: a.data
                })) : h.dispatchEvent("doubleClickStage", {captor: a.data}))
            }
            ...
            function e(a) {
                h.settings("eventsEnabled") && (h.dispatchEvent("rightClick", a.data), i.length ? (h.dispatchEvent("rightClickNode", {
                    ...
                    node: i,
                    captor: a.data
                })) : h.dispatchEvent("rightClickStage", {captor: a.data}))
            }
            ...
            function f(a) {
                if (h.settings("eventsEnabled")) {
                    ...
                    e.length && h.dispatchEvent("outNodes", {nodes: e, captor: a.data})
                }
            }
            ...
            function g(a) {
                if (h.settings("eventsEnabled")) {
                    i = b(a);
                    var c, d, e, f = [], g = [], k = {}, l = i.length;
                    for (c = 0; l > c; c++)e = i[c], k[e.id] = e, j[e.id] || (g.push(e), j[e.id] = e);
                    for (d in j)k[d] || (f.push(j[d]), delete j[d]);
                    for (c = 0, l = g.length; l > c; c++)h.dispatchEvent("overNode", {node: g[c], captor: a.data});
                    for (c = 0, l = f.length; l > c; c++)h.dispatchEvent("outNode", {node: f[c], captor: a.data});
                    g.length && h.dispatchEvent("overNodes", {
                        nodes: g,
                        captor: a.data
                    }), f.length && h.dispatchEvent("outNodes", {nodes: f, captor: a.data})
                }
            }
    ...
    sigma.utils.pkg("sigma.misc"), sigma.misc.drawHovers = function (a) {
        function b() {
            ...
            var b = sigma.canvas.hovers, e = c.settings.embedObjects({prefix: a});
            if (e("enableHovering") && e("singleHover") && d.length && (d[d.length - 1].hidden || (b[d[d.length - 1].type] || b.def)(d[d.length - 1], c.contexts.hover, e)), e("enableHovering") && !e("singleHover") && d.length)for (var f = 0; f < d.length; f++)d[f].hidden || (b[d[f].type] || b.def)(d[f], c.contexts.hover, e)
        }
